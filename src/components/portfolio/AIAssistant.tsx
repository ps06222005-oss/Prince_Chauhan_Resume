            ...
            <div className="border-t border-white/[0.08] p-3">
              <div className="mb-2 flex flex-wrap gap-1.5">
                {SUGGESTIONS.map((s) => (
                  <button
                    ...
                    onClick={() => send(s)}
                    disabled={typing}
                    className="rounded-full border border-white/[0.08] bg-white/[0.03] px-2.5 py-0.5 text-[11px] hover:bg-white/[0.06] disabled:opacity-50"
                  >
                    {s}
                  </button>
                ))}
              ...
              >
                <input
                  ...
                  className="flex-1 rounded-full border border-white/[0.08] bg-white/[0.03] px-3 py-2 text-sm outline-none focus:border-accent-blue/60"
                />
                <button
                  type="submit"
